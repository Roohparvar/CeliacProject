...
top2_genes <- head(count_matrix[order(count_matrix$pvalue), ], 2)
top2_names <- rownames(top2_genes)
...
plot(
  ...
  xlab = "% difference TRGV gene use(ACD versus Healthy)",
  ylab = "-log10(p-value)",
  pch = 20,
  col = "black",
