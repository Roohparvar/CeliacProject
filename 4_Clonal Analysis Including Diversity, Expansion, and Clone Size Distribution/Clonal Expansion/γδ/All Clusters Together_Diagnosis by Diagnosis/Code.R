setwd("C:/Esmaeil/CeliacProject/CeliacProject/4_Clonal Analysis Including Diversity, Expansion, and Clone Size Distribution/Clonal Expansion/γδ/All Clusters Together_Diagnosis by Diagnosis")
