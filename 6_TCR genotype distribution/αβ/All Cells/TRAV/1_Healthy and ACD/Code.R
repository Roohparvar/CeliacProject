setwd("C:/Esmaeil/CeliacProject/CeliacProject/6_TCR genotype distribution/αβ/All Cells/TRAV/1_Healthy and ACD")
...
colors <- c("#008080", "#FF00FF", "#800000", "#AAFFC3", "#00FFFF")
...
# Save as PNG
png("volcano_plot_top5_TRAV_ACD_vs_Healthy.png", width = 1300, height = 1600, res = 300)
...
# Save as PDF
pdf("volcano_plot_top5_TRAV_ACD_vs_Healthy.pdf", width = 6, height = 7)
