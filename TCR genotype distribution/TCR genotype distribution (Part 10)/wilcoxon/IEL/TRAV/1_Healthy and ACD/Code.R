setwd("C:/Esmaeil/CeliacProject/CeliacProject/TCR genotype distribution/TCR genotype distribution (Part 10)/wilcoxon/IEL/TRAV/1_Healthy and ACD")
...
colors <- c("#008080", "#E6BEFF", "#800000", "#AA6E28", "#3CB44B")
