...
p1 <- ggplot(df, aes(x = Patient, y = perc, fill = clone_category)) +
  ...
  labs(
    ...
    title = "γδ Clonal Size Distribution by Patient (Percentage) | All Clusters"
  ) +
  white_theme

ggsave("CloneSize_gd_Percentage_ByPatient.png", p1, width = 6, height = 5, dpi = 400, bg = "white")
...
p2 <- ggplot(df, aes(x = Patient, y = n_cells, fill = clone_category)) +
  ...
  labs(
    ...
    title = "γδ Clonal Size Distribution by Patient (Raw Counts) | All Clusters"
  ) +
  white_theme

ggsave("CloneSize_gd_RawCounts_ByPatient.png", p2, width = 6, height = 5, dpi = 400, bg = "white")
