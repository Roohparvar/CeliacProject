...
ggsave("Logo plots of the CDR3α.png", plot = p, width = 10, height = 6, dpi = 300, bg = "white")
...
# Save as high-quality PNG
ggsave("Logo plots of the CDR3β.png", plot = p, width = 10, height = 6, dpi = 300, bg = "white")