setwd("C:/Esmaeil/CeliacProject/CeliacProject/4_Clonal Expansion Analysis/Based on manually defined clone size ranges/γδ/All Clusters Together_Diagnosis by Diagnosis")
