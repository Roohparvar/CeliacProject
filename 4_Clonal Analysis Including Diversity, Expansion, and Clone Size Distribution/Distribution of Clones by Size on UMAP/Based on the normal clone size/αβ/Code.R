setwd("C:/Esmaeil/CeliacProject/CeliacProject/4_Clonal Analysis Including Diversity, Expansion, and Clone Size Distribution/Distribution of Clones by Size on UMAP/Based on the normal clone size/αβ")
...
for (diag in order_diag) {
  ...
  # Select only colored cells for this diagnosis (sorted → largest on top)p)
