setwd("C:/Esmaeil/CeliacProject/CeliacProject/6_TCR genotype distribution/αβ/All Cells/TRAV/2_Healthy and RCD1")
...
colors <- c("#AAFFC3", "#00FFFF", "#0082C8", "#008080", "orange")
...
# Save as PNG
png("volcano_plot_top4_TRAV_RCD1_vs_Healthy.png", width = 1300, height = 1600, res = 300)
...
# Save as PDF
pdf("volcano_plot_top4_TRAV_RCD1_vs_Healthy.pdf", width = 6, height = 7)
