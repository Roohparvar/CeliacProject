setwd("C:/Esmaeil/CeliacProject/CeliacProject/6_TCR genotype distribution/αβ/All Cells/TRBV/1_Healthy and ACD")
...
colors <- c("#FABEBE", "#000000", "#8B4513", "#B22222", "#FFE119")
...
# Save as PNG
png("volcano_plot_top5_TRBV_ACD_vs_Healthy.png", width = 1300, height = 1600, res = 300)
...
# Save as PDF
pdf("volcano_plot_top5_TRBV_ACD_vs_Healthy.pdf", width = 6, height = 7)
