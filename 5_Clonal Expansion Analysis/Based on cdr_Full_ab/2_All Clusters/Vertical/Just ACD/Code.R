...
# Save as PNG and PDF
ggsave("CloneSize_ab_Percentage_Vertical.png", p1, width = 6, height = 10, dpi = 400, bg = "white")
...
# Save as PNG and PDF
ggsave("CloneSize_ab_RawCounts_Vertical.png", p2, width = 6, height = 10, dpi = 400, bg = "white")