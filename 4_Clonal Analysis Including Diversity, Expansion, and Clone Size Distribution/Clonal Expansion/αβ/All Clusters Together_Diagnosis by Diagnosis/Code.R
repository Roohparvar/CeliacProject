setwd("C:/Esmaeil/CeliacProject/CeliacProject/4_Clonal Analysis Including Diversity, Expansion, and Clone Size Distribution/Clonal Expansion/αβ/All Clusters Together_Diagnosis by Diagnosis")
...
df <- metadata_filtered %>%
  ...
  complete(Diagnosis, clone_category = c("Singleton", "Q1(~50): 2-5", "Q2(51~75): 6-25", "Q3(76~90): 26-338", "Q4(91~100): 339-675"),
           fill = list(n_cells = 0)) %>%
  group_by(Diagnosis) %>%
...
df$clone_category <- factor(df$clone_category, levels = rev(c("Singleton", "Q1(~50): 2-5", "Q2(51~75): 6-25", "Q3(76~90): 26-338", "Q4(91~100): 339-675")))
