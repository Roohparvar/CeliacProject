setwd("C:/Esmaeil/CeliacProject/CeliacProject/6_TCR genotype distribution/αβ/All Cells/TRAV/3_ACD and RCD1")
...
colors <- c("#FFB6C1", "#800000", "#0082C8", "purple", "orange")
...
pdf("volcano_plot_top3_TRAV_ACD_vs_RCD1.pdf", width = 6, height = 7)
