...
p2 <- ggplot(cluster_diversity, aes(x = cluster, y = shannon_norm)) +
...
# ذخیره نمودارها
ggsave("shannon_diversity.png", plot = p1, width = 10, height = 5, dpi = 300, bg = "white")
ggsave("shannon_norm_diversity.png", plot = p2, width = 10, height = 5, dpi = 300, bg = "white")

# نمایش دیتا فریم نهایی
print(cluster_diversity)
