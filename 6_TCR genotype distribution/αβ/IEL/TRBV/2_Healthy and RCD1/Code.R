setwd("C:/Esmaeil/CeliacProject/CeliacProject/6_TCR genotype distribution/αβ/IEL/TRBV/2_Healthy and RCD1")
...
pdf("volcano_plot_pvalue_top5_TRBV_RCD1_vs_Healthy.pdf", width = 6, height = 7)
